...
# Arguments
arguments = --config {config_path} --participant-label $(sub) --session-label $(ses)
...
request_memory = {int(self.config.memory_gb)}GB
getenv = True

# Queue
queue sub,ses from {subjects_file}
"""
