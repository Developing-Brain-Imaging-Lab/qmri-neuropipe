...
class NormalizationWorkflow(BaseWorkflow):
    ...
    def build_pipeline(self, context: dict) -> None:
        ...
        step = NormalizationStep(
            ...
            space_name=cfg.get("space_name", cfg.get("space_entity", cfg.get("space", "Standard"))),
            space_entity=cfg.get("space_entity", cfg.get("space_name", cfg.get("space", "Standard"))),
            ...
            synthmorph_model=cfg.get("synthmorph_model"),
            synthmorph_transform_ext=cfg.get("synthmorph_transform_ext"),
