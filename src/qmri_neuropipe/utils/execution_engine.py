...
class ExecutionEngine:
    ...
    def _get_global_step_types(self):
        ...
        try:
            ...
            return (Synb0EstimationStep, TopupStep, ApplyTopupStep, SyntheticReversePEStep, GradientCheckStep, DMRIReorientStep, MergeStep, NativeDrbuddiStep, TortoiseV4CorrectionStep)
