...
from dmipy.core.fitted_modeling_framework import (
    FittedMultiCompartmentModel,
    FittedMultiCompartmentSphericalMeanModel,
    FittedMultiCompartmentSphericalHarmonicsModel)
from dmipy.optimizers.brute2fine import (
    GlobalBruteOptimizer, Brute2FineOptimizer)
from dmipy.optimizers.mix import MixOptimizer
from dmipy.optimizers.multi_tissue_convex_optimizer import (
    MultiTissueConvexOptimizer)
from dmipy.optimizers_fod.csd_cvxpy import CsdCvxpyOptimizer
from dmipy.optimizers_fod.csd_tournier import CsdTournierOptimizer
...
class MultiCompartmentModel(MultiCompartmentModelProperties):
    ...
    def fit(self, acquisition_scheme, data,
            mask=None, grad_nonlin=None, bvals=None, bvecs=None, solver='brute2fine', Ns=5, maxiter=300,
