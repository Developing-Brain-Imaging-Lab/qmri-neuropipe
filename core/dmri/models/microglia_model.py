...
# class MICROGLIA_Model():
#     def __init__(self, dwi_img, sub_info, out_dir, mask=None, solver='brute2fine', parallel_diffusivity=1.7e-9, iso_diffusivity=3e-9, nthreads=1, verbose=False):
#         self._inputs = {}
