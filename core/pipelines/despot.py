...
from core.utils.despot.json import create_processing_json
import core.utils.despot.coregistration as despot_coreg
import core.utils.afi as afi_tools

from core.models.despot.despot1 import DESPOT1_Model
from core.models.despot.despot2 import DESPOT2_Model
from core.models.despot.mcdespot import MCDESPOT_Model
...
class DESPOTProcessingPipeline:
    ...
    def run(self):
        ...
        if not os.path.exists(target_img._get_filename()):
            ...
            ref_img = nib.Nifti1Image(spgr.get_data()[:,:,:,num_spgr-1], spgr.affine)
